...
public class TifannyPatrianeAndariSQLite extends Activity  implements OnClickListener, OnItemLongClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_tifanny_patriane_andari_sqlite);
	    ...
	    TifannyPatrianeAndariDataHelper dh = new TifannyPatrianeAndariDataHelper(this);
	    Cursor c = dh.getAll();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    getMenuInflater().inflate(R.menu.activity_tifanny_patriane_andari_sqlite, menu);
	    return true;
	}
	...
	public void onClick(View v) {
	    switch (v.getId()) {
	        case R.id.tambahButton:
	            startActivity(new Intent(this, TifannyPatrianeAndariAddSQLite.class));
	            break;
