package com.example.andri.firman.saputra;
...
public class AndriFirmanSaputra extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_andri_firman_saputra);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_andri_firman_saputra, menu);
        return true;
    }
