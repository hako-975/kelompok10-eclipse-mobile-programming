package com.example.tifannypatrianeandarigrafik;
...
public class TifannyPatrianeAndariGrafik extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_tifanny_patriane_andari_grafik, menu);
        return true;
    }
