...
public class BaniMaskurMuhammadAlWaladTempatGambar extends View implements OnTouchListener {

	List<Titik> lokasiTitik = new ArrayList<Titik>();
    Paint paint = new Paint();

    public BaniMaskurMuhammadAlWaladTempatGambar(Context context) {
        super(context);
        setFocusable(true);
