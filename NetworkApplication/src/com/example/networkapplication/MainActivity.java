...
public class MainActivity extends Activity implements OnClickListener {
    private String torestoXmlAddress = "https://w3schools.com/xml/note.xml";
    private String torestoJsonAddress = "https://gist.githubusercontent.com/cbmgit/852c2702d4342e7811c95f8ffc2f017f/raw/InsuranceCompanies.json";
    ...
    public void parseSimpleXml() {
        try {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    Toast toast = Toast.makeText(MainActivity.this, "Ada " +
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(MainActivity.this, items, R.layout.custom_list_4, from, to);
        ...
        protected void onPostExecute(GResult result) {
            ...
            if (result != null) {
                Toast.makeText(MainActivity.this, "Ada " +
                        result.getResult().getCount() + " data", Toast.LENGTH_SHORT).show();

                items.clear();
                Map<String, String> map;
                for (int i = 0; i < result.getResult().getData().size(); i++) {
                    map = new HashMap<String, String>();
                    map.put(ID, Integer.toString(result.getResult().getData().get(i).getId()));
                ...
                SimpleAdapter adapter = new SimpleAdapter(MainActivity.this, items, R.layout.custom_list_3, from, to);
                listView.setAdapter(adapter);
            } else {
