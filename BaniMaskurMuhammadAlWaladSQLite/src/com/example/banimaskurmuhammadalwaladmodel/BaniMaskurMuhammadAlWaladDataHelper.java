package com.example.banimaskurmuhammadalwaladmodel;
...
public class BaniMaskurMuhammadAlWaladDataHelper {
    ...
    private static final String INSERT = "insert into " + TABLE_NAME + "(judul, isi) values (?,?)";
    
    public BaniMaskurMuhammadAlWaladDataHelper(Context context) {
