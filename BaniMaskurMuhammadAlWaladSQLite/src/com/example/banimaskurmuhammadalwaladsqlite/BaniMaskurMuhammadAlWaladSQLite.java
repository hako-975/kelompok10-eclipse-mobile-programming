...
public class BaniMaskurMuhammadAlWaladSQLite extends Activity implements OnClickListener, OnItemLongClickListener {
	ListView listView;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_bani_maskur_muhammad_al_walad_sqlite);
	    ...
	    BaniMaskurMuhammadAlWaladDataHelper dh = new BaniMaskurMuhammadAlWaladDataHelper(this);
	    Cursor c = dh.getAll();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    getMenuInflater().inflate(R.menu.activity_bani_maskur_muhammad_al_walad_sqlite, menu);
	    return true;
	}
	...
	public void onClick(View v) {
	    switch (v.getId()) {
	        case R.id.tambahButton:
	            startActivity(new Intent(this, BaniMaskurMuhammadAlWaladAddSQLite.class));
	            break;
