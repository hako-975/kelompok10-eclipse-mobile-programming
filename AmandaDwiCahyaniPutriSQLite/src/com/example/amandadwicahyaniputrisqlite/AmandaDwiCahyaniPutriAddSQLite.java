...
public class AmandaDwiCahyaniPutriAddSQLite extends Activity {
	AmandaDwiCahyaniPutriDataHelper dh;
	EditText judul, isi;
	int id = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_amanda_dwi_cahyani_putri_add_sqlite);

	    judul = (EditText) findViewById(R.id.judulEditText);
	    isi = (EditText) findViewById(R.id.isiEditText);

	    dh = new AmandaDwiCahyaniPutriDataHelper(this);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    getMenuInflater().inflate(R.menu.activity_amanda_dwi_cahyani_putri_add_sqlite, menu);
	    return true;
	}
