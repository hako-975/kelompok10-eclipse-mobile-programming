...
public class RahmatPrasetyoAddSQLite extends Activity {
	RahmatPrasetyoDataHelper dh;
	EditText judul, isi;
	int id = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_rahmat_prasetyo_add_sqlite);

	    judul = (EditText) findViewById(R.id.judulEditText);
	    isi = (EditText) findViewById(R.id.isiEditText);

	    dh = new RahmatPrasetyoDataHelper(this);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    getMenuInflater().inflate(R.menu.activity_rahmat_prasetyo_add_sqlite, menu);
	    return true;
	}
