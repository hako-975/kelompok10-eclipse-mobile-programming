...
public class HitungAngka extends Activity {

	// R.1
	TextView input1, input2, operator, result, notif;
	Button btHitung, btJumlah, btKurang, 
	btKali, btBagi;
	//V.1
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        notif = (TextView) findViewById(R.id.operan);
        //R.3
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_hitung_angka, menu);
        return true;
    }
}
