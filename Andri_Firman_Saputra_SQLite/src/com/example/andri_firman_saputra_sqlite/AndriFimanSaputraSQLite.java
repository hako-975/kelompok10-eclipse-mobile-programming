...
public class AndriFimanSaputraSQLite extends Activity  implements OnClickListener, OnItemLongClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_andri_fiman_saputra_sqlite);
	    ...
	    AndriFirmanSaputraDataHelper dh = new AndriFirmanSaputraDataHelper(this);
	    Cursor c = dh.getAll();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    getMenuInflater().inflate(R.menu.activity_andri_fiman_saputra_sqlite, menu);
	    return true;
	}
	...
	public void onClick(View v) {
	    switch (v.getId()) {
	        case R.id.tambahButton:
	            startActivity(new Intent(this, AndriFirmanSaputraAddSQLiteActivity.class));
	            break;
