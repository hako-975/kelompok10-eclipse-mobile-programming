package com.example.rahmatprasetyografik;
...
public class RahmatPrasetyoGrafik extends Activity {
	@Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_rahmat_prasetyo_grafik, menu);
        return true;
    }
