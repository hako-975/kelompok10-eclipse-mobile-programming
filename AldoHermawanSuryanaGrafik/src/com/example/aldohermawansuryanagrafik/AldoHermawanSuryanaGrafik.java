package com.example.aldohermawansuryanagrafik;
...
public class AldoHermawanSuryanaGrafik extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_aldo_hermawan_suryana_grafik, menu);
        return true;
    }
