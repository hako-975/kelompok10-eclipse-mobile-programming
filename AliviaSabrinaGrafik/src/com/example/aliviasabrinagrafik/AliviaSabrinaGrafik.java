package com.example.aliviasabrinagrafik;
...
public class AliviaSabrinaGrafik extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_alivia_sabrina_grafik, menu);
        return true;
    }
